...
app.post('/send', (req, res) => {
  ...
  let mailOptions = {
      from: '"Be.Digital, India" <contact@bdigital.tech>', // sender address
      to: 'viralpatel.patel78@gmail.com, darpanpatel2018@gmail.com', // list of receivers
      subject: 'Barodaganesh | New Entry', // Subject line
